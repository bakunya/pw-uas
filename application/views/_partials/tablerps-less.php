<div class="table-responsive">
    <table class="table table-borderless mt-5 align-middle">
        <thead>
            <th class="w-200 py-3 px-0">Kode Mata Kuliah</th>
            <th class="w-200 py-3 px-0">Mata Kuliah</th>
            <th class="w-200 py-3 px-0">Action</th>
        </thead>
        <tbody>
            <?php foreach ($rps as $k => $v) : ?>
                <tr>
                    ...
                    <td class="py-3 px-0 d-flex">
                        <a href="<?= base_url('rps?curr_id=' . $v['id']) ?>" class="btn btn-success"><small><strong>Lihat RPS</strong></small></a>
